...
//              				<WebView bounces={false} onLoadProgress = {({ nativeEvent }) => {
// 							      this.setState({progress:nativeEvent.progress})}} scalesPageToFit={true} source={{uri: urlStr}} style={{width:Window_width, height:Window_height}}>
//              				</WebView>
//            				</View>
// 				</View>
// 			)
